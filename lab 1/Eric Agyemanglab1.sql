...
COMMIT;
-- END LAB #1 DDL---- Lab #1 Question s
--1 Find the names of sailors who have reserved boat number 102
--2 Find the names of sailors who have reserved any boat other than boat number 102
--EXTRA CREDIT
--+2 points extra for --- find ALL sailors who have NEVER reserved boat 102
--3 Find the names of sailors who have reserved a blue boat
--4 Find the colors of boats reserved by Rusty
--5 Find the names of sailors who have reserved at least one boat
--6 Find the names of sailors who have reserved a red or a blue boat
-- DO NOT SUBMIT THIS PART
--7 After you have com pleted all of th e above, drop the
